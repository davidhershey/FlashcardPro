    ...
    :QDialog()
{
    ...
    mocFlashcards.push_back(new Flashcard("Click anywhere on the flashcard to flip it. Try doing it now."
                                          , "If you got the correct answer, click the green check. If you got the wrong answer, click the red x. Click either now.", 0));
...
QFrame* Tutorial::createUserTutPage()
{
    ...
    QLabel* line3 = new QLabel("we suggest that you continue through this quick tutorial.");
    QLabel* line4 = new QLabel("You can exit the tutorial at any time by closing this window.");
    QLabel* line5 = new QLabel("Click the next button to proceed...");
    line1->setFont(naxa);
    line2->setFont(naxa);
    line3->setFont(naxa);
    line4->setFont(naxa);
    line5->setFont(naxa_b);
...
QFrame* Tutorial::createDecksViewTutPage()
{
    ...
    QFrame* frame = new QFrame(this);
    frame->setMaximumSize(700,500);
    QLabel* line1 = new QLabel("Selecting your username will bring you to all of your decks. ");
    QLabel* line2 = new QLabel("There are currently no decks created.");
    QLabel* line3 = new QLabel("Clicking on the plus sign will let you load a .dek file ");
    QLabel* line4 = new QLabel("or create a new deck with our deck builder.");
    QLabel* line5 = new QLabel("Try clicking the plus sign and then click next to proceed...");
    line1->setFont(naxa);
    line2->setFont(naxa);
    line3->setFont(naxa);
    line4->setFont(naxa);
...
QFrame* Tutorial::createStudyAreaTutPage()
{
    ...
    QFrame* frame = new QFrame(this);
    frame->setMaximumSize(700,500);
    QLabel* line1 = new QLabel("Clicking study deck brings you to the Study Area. ");
    QLabel* line2 = new QLabel( "Click on the flashcards to get useful tips.");
    line1->setFont(naxa);
    line2->setFont(naxa);
